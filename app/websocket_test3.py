...
async def stream():
    async with websockets.connect("ws://localhost:3000/api/live/zef", extra_headers={'Authorization': 'Bearer eyJrIjoiMGNYYnJkNEM3NVpLOVp3ajFoM3ZxcEwzbncxR0RKaFgiLCJuIjoic3RyZWFtX2tleTIiLCJpZCI6MX0='}) as websocket:
        i = 0
        while True:
